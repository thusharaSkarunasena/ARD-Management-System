 ...
 */
public class CustomerReturnDetailsController implements Initializable {

    @FXML
    private AnchorPane customerReturnDetailsAnchPane;
    @FXML
    ...
    private void loadMainDash(MouseEvent event) throws IOException {
        ...
        Stage stage=(Stage) this.customerReturnDetailsAnchPane.getScene().getWindow();
