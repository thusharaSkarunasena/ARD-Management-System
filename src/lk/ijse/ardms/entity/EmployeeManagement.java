...
public class EmployeeManagement {
    ...
    public EmployeeManagement(String empid, String name, String employment, String address_no, String address_street, String address_village, String address_city, String nic, String tel_home, String tel_mobile, String otherDetails) {
        this.empid = empid;
        this.name = name;
    ...
    public String toString() {
        return "EmployeeManagement{" + "empid=" + empid + ", name=" + name + ", employment=" + employment + ", address_no=" + address_no + ", address_street=" + address_street + ", address_village=" + address_village + ", address_city=" + address_city + ", nic=" + nic + ", tel_home=" + tel_home + ", tel_mobile=" + tel_mobile + ", otherDetails=" + otherDetails + '}';
    }
