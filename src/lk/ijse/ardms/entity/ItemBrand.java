...
public class ItemBrand {
    ...
    public ItemBrand(String braId, String name, String description, String otherDetails) {
        this.braId = braId;
        this.name = name;
    ...
    public String toString() {
        return "ItemBrand{" + "braId=" + braId + ", name=" + name + ", description=" + description + ", otherDetails=" + otherDetails + '}';
    }
