...
public class SupplierManagement {
    ...
    public SupplierManagement(String supid, String name, String company, String address_no, String address_street, String address_village, String address_city, String nic, String tel_office, String tel_mobile, String email, String otherDetails) {
        this.supid = supid;
        this.name = name;
    ...
    public String toString() {
        return "SupplierManagement{" + "supid=" + supid + ", name=" + name + ", company=" + company + ", address_no=" + address_no + ", address_street=" + address_street + ", address_village=" + address_village + ", address_city=" + address_city + ", nic=" + nic + ", tel_office=" + tel_office + ", tel_mobile=" + tel_mobile + ", email=" + email + ", otherDetails=" + otherDetails + '}';
    }
