 ...
 */
public class PlaceCustomerBill {
    ...
    public PlaceCustomerBill() {
    }

    public PlaceCustomerBill(String refno, String billno, String cusid, String date, String empid, ArrayList<BillingManagementTM> billingManagementTMs, double tot_Amount, double discount, double net_Amount, String billPaymentNo, String PaymentType, double payble_total) {
        this.refno = refno;
        this.billno = billno;
        this.cusid = cusid;
        this.date = date;
    ...
    public String toString() {
        return "PlaceCustomerBill{" + "refno=" + refno + ", billno=" + billno + ", cusid=" + cusid + ", date=" + date + ", empid=" + empid + ", billingManagementTMs=" + billingManagementTMs + ", tot_Amount=" + tot_Amount + ", discount=" + discount + ", net_Amount=" + net_Amount + ", billPaymentNo=" + billPaymentNo + ", PaymentType=" + PaymentType + ", payble_total=" + payble_total + '}';
    }
