...
public class CustomerManagement {
    ...
    public CustomerManagement(String cusid, String name, String address_no, String address_street, String address_village, String address_city, String nic, String tel_home, String tel_mobile, String email) {
        this.cusid = cusid;
        this.name = name;
    ...
    public String toString() {
        return "CustomerManagement{" + "cusid=" + cusid + ", name=" + name + ", address_no=" + address_no + ", address_street=" + address_street + ", address_village=" + address_village + ", address_city=" + address_city + ", nic=" + nic + ", tel_home=" + tel_home + ", tel_mobile=" + tel_mobile + ", email=" + email + '}';
    }
