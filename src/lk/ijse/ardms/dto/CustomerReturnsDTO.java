...
public class CustomerReturnsDTO {
    ...
    public CustomerReturnsDTO() {
    }

    public CustomerReturnsDTO(String CRNo, String refNo, String billDate, String status, String customerName, String itemcode1, int qty1, String itemcode2, int qty2, String itemcode3, int qty3, String itemcode4, int qty4, String itemcode5, int qty5, String details, double releasedAmount) {
        this.CRNo = CRNo;
        this.refNo = refNo;
    ...
    public String toString() {
        return "CustomerReturnsDTO{" + "CRNo=" + CRNo + ", refNo=" + refNo + ", billDate=" + billDate + ", status=" + status + ", customerName=" + customerName + ", itemcode1=" + itemcode1 + ", qty1=" + qty1 + ", itemcode2=" + itemcode2 + ", qty2=" + qty2 + ", itemcode3=" + itemcode3 + ", qty3=" + qty3 + ", itemcode4=" + itemcode4 + ", qty4=" + qty4 + ", itemcode5=" + itemcode5 + ", qty5=" + qty5 + ", details=" + details + ", releasedAmount=" + releasedAmount + '}';
    }
